...
const Footer = () => {
    ...
    return (
        <footer
            className={`${colors.bg} ${colors.textMain} border-t ${colors.border} pt-10 pb-6 transition-colors duration-300`}
            id="footer"
        >
                    ...
                    <div className="w-full md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8">
                        <div className="site-footer__inner">
                            ...
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <p className={`text-2xl font-extrabold ${colors.logoText} tracking-tight`}>
                                    VolunteerHub
                                </p>
                            </div>

                            <p className={`text-sm mb-6 ${colors.textSub} leading-relaxed max-w-md`}>
                            ...
                            <div className="site-footer__info space-y-4">
                                <dl className="flex items-start">
                                    <dt className={`mr-3 mt-1 ${colors.accent}`}>
                                    ...
                                    <dd className={`text-sm ${colors.textSub}`}>Địa chỉ: 144 Xuân Thủy, Cầu Giấy, Hà Nội</dd>
                                </dl>
                                <dl className="flex items-start">
                                    <dt className={`mr-3 mt-1 ${colors.accent}`}>
                                    ...
                                    <dd className={`text-sm ${colors.textSub}`}>
                                        Hotline: <a href="tel:02437547461" className={`${colors.hover} transition-colors font-medium`}>024.3754.7461</a>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap h-full content-start">
                            ...
                            <div className="w-1/2 pr-4">
                                ...
                                <ul className="text-sm space-y-4">
                                    <li><Link to="/events" className={`${colors.textSub} ${colors.hover} transition-colors`}>Khám phá sự kiện</Link></li>
                                    <li><Link to="/news" className={`${colors.textSub} ${colors.hover} transition-colors`}>Tin tức nổi bật</Link></li>
                                    <li><Link to="/about" className={`${colors.textSub} ${colors.hover} transition-colors`}>Về chúng tôi</Link></li>
                                    <li><Link to="/help" className={`${colors.textSub} ${colors.hover} transition-colors`}>Hướng dẫn đăng ký</Link></li>
                                </ul>
                            </div>
                            ...
                            <div className="w-1/2">
                                ...
                                <ul className="text-sm space-y-4">
                                    <li><Link to="/register?role=organizer" className={`${colors.textSub} ${colors.hover} transition-colors`}>Đăng ký thành viên</Link></li>
                                    <li><Link to="/organizer/events/create" className={`${colors.textSub} ${colors.hover} transition-colors`}>Tạo chiến dịch mới</Link></li>
                                    <li><Link to="/terms" className={`${colors.textSub} ${colors.hover} transition-colors`}>Quy định & Chính sách</Link></li>
                                    <li><Link to="/contact" className={`${colors.textSub} ${colors.hover} transition-colors`}>Liên hệ hợp tác</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
