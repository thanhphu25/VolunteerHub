/**
 * Dashboard Page
 * Role-adaptive dashboard displaying different content based on user role.
 * Shows newly approved events, trending events, and role-specific statistics for admin/organizer.
 * Includes push notification management and quick action buttons.
 *
 * @component
 * @returns {JSX.Element} Dashboard page with role-specific content and analytics
 */
...
export default function Dashboard() {
  ...
  const loadDashboardData = useCallback(async () => {
    ...
    try {
      ...
      try {
        const trendingRes = await eventApi.getTrending(6);
        data.trendingEvents = trendingRes.data || [];
      } catch (e) {
